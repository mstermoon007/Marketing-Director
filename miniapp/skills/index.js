...
exports.REAL_ESTATE_DIAGNOSIS_DIMENSIONS = exports.INDUSTRY_DIAGNOSIS_TIPS = exports.REAL_ESTATE_SUBCATEGORIES = exports.INDUSTRY_SKILLS = void 0;
exports.getIndustrySkill = getIndustrySkill;
exports.getDiagnosisTips = getDiagnosisTips;
exports.getSkillContext = getSkillContext;
exports.prepareDiagnosisWithSkill = prepareDiagnosisWithSkill;
exports.listIndustryOptions = listIndustryOptions;
exports.listRealEstateSubcategories = listRealEstateSubcategories;
exports.getRealEstateDimensions = getRealEstateDimensions;
exports.isRealEstate = isRealEstate;
/** 行业技能映射（地产为核心，支持子类细分） */
exports.INDUSTRY_SKILLS = {
    // ── 地产行业（核心）──
...
/** 地产行业子类选项（用于表单选择） */
exports.REAL_ESTATE_SUBCATEGORIES = [
...
/** 行业诊断建议（前端展示用） */
exports.INDUSTRY_DIAGNOSIS_TIPS = {
    real_estate: [
...
/** 地产行业诊断维度说明（用于诊断报告展示） */
exports.REAL_ESTATE_DIAGNOSIS_DIMENSIONS = [
...
function getIndustrySkill(industry) {
    ...
    const skill = exports.INDUSTRY_SKILLS[industry];
    if (skill) {
        return skill;
    }
    for (const [alias, info] of Object.entries(exports.INDUSTRY_SKILLS)) {
 ...
 * 获取行业诊断建议
 */
function getDiagnosisTips(industry) {
    const skill = getIndustrySkill(industry);
    return exports.INDUSTRY_DIAGNOSIS_TIPS[skill.key] || exports.INDUSTRY_DIAGNOSIS_TIPS.generic;
}
/**
 * 获取诊断时注入的技能上下文
 */
function getSkillContext(industry) {
    const skill = getIndustrySkill(industry);
 ...
 * 生成诊断前的准备信息
 */
function prepareDiagnosisWithSkill(industry) {
    const skill = getIndustrySkill(industry);
 ...
 */
function listIndustryOptions() {
    const seen = new Set();
    const options = [];
    for (const [value, info] of Object.entries(exports.INDUSTRY_SKILLS)) {
 ...
 * 获取地产行业子类选项
 */
function listRealEstateSubcategories() {
    return exports.REAL_ESTATE_SUBCATEGORIES;
}
/**
 * 获取地产诊断维度列表
 */
function getRealEstateDimensions() {
    return exports.REAL_ESTATE_DIAGNOSIS_DIMENSIONS;
}
/**
 * 判断是否为地产行业
 */
