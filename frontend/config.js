...
exports.DEV_DEFAULT_URL = exports.PROD_DEFAULT_URL = exports.DEV_PORT = void 0;
exports.resolveDevBaseUrl = resolveDevBaseUrl;
...
function resolveDevBaseUrl() {
    ...
    try {
        const stored = (_a = wx === null || wx === void 0 ? void 0 : wx.getStorageSync) === null || _a === void 0 ? void 0 : _a.call(wx, storage_1.STORAGE_KEYS.DEV_API_BASE);
    ...
    try {
        const app = getApp();
        const g = (_b = app === null || app === void 0 ? void 0 : app.globalData) === null || _b === void 0 ? void 0 : _b.DEV_API_BASE;
        if (g && /^https?:\/\//.test(g))
            return g;
    }
    catch ( /* ignore */_d) { /* ignore */ }
    // 3. 默认值
    return exports.DEV_DEFAULT_URL;
}
